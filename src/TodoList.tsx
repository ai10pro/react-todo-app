            ...
            {todos.map((todo) => (
                <div
                    ...
                    className={twMerge(
                        ...
                        todo.isDone && "bg-blue-50 opacity-50", todo.deadline && todo.deadline < new Date() && "bg-red-100"
                    )}
                >
                    <div className="flex items-baseline text-slate-700">
                        <FontAwesomeIcon icon={todo.isDone ? faFileCircleCheck : faFile} className="mr-1" />
                        <div
                            className={twMerge(
                    ...
                    <div className="">
                        {todo.deadline ? (
                            <div className="pl-6 text-s text-slate-500">
                                期限: {todo.deadline.toLocaleDateString('ja-JP', {
                                    year: 'numeric',
                                    month: '2-digit',
                                    day: '2-digit',
                                    weekday: 'short',
